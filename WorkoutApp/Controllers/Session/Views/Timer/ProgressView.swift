...
extension TimerView {
    final class ProgressView: UIView {
        ...
        func drawProgress(with percent: CGFloat) {
            ...
            defaultCircleLayer.strokeColor = Resourses.Colors.separator.cgColor
            ...
            bigDotLayer.strokeColor = Resourses.Colors.active.cgColor
            ...
            (1...9).forEach { _ in
                ...
                ? Resourses.Colors.active.cgColor : Resourses.Colors.separator.cgColor
